...
, ('bc_375', (SELECT measurands_id FROM measurands WHERE measurand = 'bc_375'), '', 'cac')
, ('bc_470', (SELECT measurands_id FROM measurands WHERE measurand = 'bc_470'), '', 'cac')
, ('bc_528', (SELECT measurands_id FROM measurands WHERE measurand = 'bc_528'), '', 'cac')
, ('bc_625', (SELECT measurands_id FROM measurands WHERE measurand = 'bc_625'), '', 'cac')
, ('bc_880', (SELECT measurands_id FROM measurands WHERE measurand = 'bc_880'), '', 'cac')
, ('wd', 22, '', 'cac')
, ('ws', 34, '', 'cac')
, ('nox', 23, '', 'cpcb')
...
, ('no2_mass', 5, '', 'kiwis')
, ('nox_mass', 27, '', 'kiwis')
, ('humidity', 134, '', 'senstate')
, ('pm4', 19844, '', 'senstate')
, ('co', 4, 'ppb', 'senstate')
, ('no2', 5, 'ppb', 'senstate')
, ('so2', 6, 'ppb', 'senstate')
, ('co', 102, 'ug/m3', 'data354')
, ('no2', 15, 'ug/m3', 'data354')
, ('so2', 101, 'ug/m3', 'cpcb')
, ('co', 102, 'ug/m3', 'cpcb')
, ('no2', 15, 'ug/m3', 'cpcb')
, ('no2', 15, 'ug/m3', 'aurassure')
ON CONFLICT DO NOTHING
;
