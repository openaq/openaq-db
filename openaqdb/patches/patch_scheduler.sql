...
GRANT USAGE ON SCHEMA fetcher TO apiuser, rwuser;
GRANT SELECT ON ALL TABLES IN SCHEMA fetcher TO apiuser;
GRANT ALL ON ALL TABLES IN SCHEMA fetcher TO rwuser;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA fetcher TO rwuser;
